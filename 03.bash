...
/BiO/Share/Tools/gatk-4.6.1.0/gatk Mutect2 --java-options "-XX:+UseSerialGC -Xmx20g" --reference /BiO/Share/Tools/gatk-bundle/hg38/Homo_sapiens_assembly38.fasta --input 12N.Sort.MarkDuplicates.BQSR.bam --input TUMOR.Sort.MarkDuplicates.BQSR.bam --12N-sample 12N --output SAMPLE.vcf --native-pair-hmm-threads 10 --max-mnp-distance 0
...
/usr/bin/perl /BiO/Share/Tools/vcf2maf-1.6.21/vcf2maf.pl --vep-path /BiO/Share/Tools/ensembl-vep-release-110.1/ --vep-data /BiO/Share/Tools/ensembl-vep-release-110.1/ --vep-forks 10 --ncbi-build 'GRCh38' --input-vcf SAMPLE.PASS.vcf --output SAMPLE.PASS.maf --tumor-id TUMOR --12N-id 12N --ref-fasta /BiO/Share/Tools/gatk-bundle/hg38/Homo_sapiens_assembly38.fasta --vep-overwrite
